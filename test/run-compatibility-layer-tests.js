/**
 * Compatibility Layer テストランナー
 * CompatibilityLayerの動作確認テストを実行
 */
...
const scripts = [
  ...
  "../infrastructure/migration-scripts.js",
  "../infrastructure/compatibility-layer.js",
  "test-compatibility-layer.js",
];
...
async function runTests() {
  try {
    ...
    console.log("Compatibility Layer Test Runner");
    console.log("=".repeat(60));
    ...
    // テストを実行
    console.log("\n🧪 Running Compatibility Layer tests...");
    const testSuite = new CompatibilityLayerTest();
