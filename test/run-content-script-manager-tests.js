/**
 * ContentScriptManager テストランナー
 * ContentScriptManagerの単体テストを実行する
 */
...
const dependencies = [
  ...
  "../infrastructure/content-script-manager.js",
  "./test-content-script-manager.js",
];
...
async function runTests() {
  try {
    console.log("=== ContentScriptManager Test Runner ===");
    ...
    // テストを実行
    console.log("\nStarting tests...\n");
    const results = await runContentScriptManagerTests();
...
function initializeTestRunner() {
  ...
  title.textContent = "ContentScriptManager Test Runner";
...
// グローバルに公開（デバッグ用）
window.runContentScriptManagerTestRunner = runTests;
