/**
 * Migration Scripts テストランナー
 * MigrationScriptsの動作確認テストを実行
 */
...
async function runTests() {
  try {
    ...
    console.log("Migration Scripts Test Runner");
    console.log("=".repeat(60));
    ...
    // テストを実行
    console.log("\n🧪 Running Migration Scripts tests...");
    const testSuite = new MigrationScriptsTest();
