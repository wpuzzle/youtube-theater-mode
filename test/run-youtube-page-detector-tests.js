/**
 * YouTubePageDetector テストランナー
 * YouTubePageDetectorの単体テストを実行する
 */
...
const dependencies = [
  ...
  "../infrastructure/youtube-page-detector.js",
  "./test-youtube-page-detector.js",
];
...
async function runTests() {
  try {
    console.log("=== YouTubePageDetector Test Runner ===");
    ...
    // テストを実行
    console.log("\nStarting tests...\n");
    const results = await runYouTubePageDetectorTests();
...
function initializeTestRunner() {
  ...
  title.textContent = "YouTubePageDetector Test Runner";
...
// グローバルに公開（デバッグ用）
window.runYouTubePageDetectorTestRunner = runTests;
